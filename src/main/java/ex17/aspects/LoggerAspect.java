package ex17.aspects;

import ex17.services.VehicleServices;
...
public class LoggerAspect {
    ...
    @Around("execution(* ex17.services.*.playMusic(..))")
    ...
    @Around("@annotation(ex17.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* ex17.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* ex17.services.*.*(..))",returning = "retVal")
